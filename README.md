...
![구독 폼](screenshots/ui-home.png)

**리포트 목록**

![리포트 목록](screenshots/ui-reports.png)

**리포트 상세 + 파이프라인 실행 버튼**

![리포트 상세](screenshots/ui-report-detail.png)

### 생성된 이메일 리포트

버튼 한 번으로 생성된 실제 이메일:

![이메일 리포트](screenshots/email-result.png)

| 구성 요소 | 설명 |
|----------|------|
| **오늘의 핵심** | AI가 생성한 전체 시장 요약 (1~2문단) |
| **영향도 태그** | 각 기사에 HIGH / MEDIUM / LOW 표시 |
| **출처 + 원문 링크** | `[원문 보기]` 클릭 시 원본 신문 기사로 이동 |
| **한국어 번역 + 핵심 요약** | 긴 기사를 2~3줄 핵심으로 압축 |
